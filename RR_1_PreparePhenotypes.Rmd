---
title: "UKB phenotypic data formatting"
...
We have created a csv file using the R package *ukbtools* which contains all phenotypes available as part of our application, but limited to the participants imaged  
...
# Sex variable changed name when updating ukbtools - sexuses_datacoding_9_f31_0_0 coded 0-1 became sex_f31_0_0 coded Female-Male
...
Each phenotype is written in an individual tab separated file with 3 columns (no column names) **eid eid phenotype**  
This way we can easily loop on phenotypes in the models by selecting the relevant file  
