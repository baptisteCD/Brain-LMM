...
# Run QC and export list of participants to exclude (deprecated)
# This QC approach was used for the discovery sample in the article, before exclusion was implemented in OSCA.
